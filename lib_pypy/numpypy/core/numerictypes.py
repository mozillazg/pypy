...
from numpypy import ndarray, array, empty, dtype, typeinfo
...
from __builtin__ import bool, int, long, float, complex, object, unicode, str, str as bytes
...
_toadd.remove('complex')
_toadd.remove('object')
_toadd.remove('object')
