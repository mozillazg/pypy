#! /usr/bin/env python
"""
Usage:  sudanpython.py <module-name> [dll-name]

Compiles an RPython module into a .abc file.
"""
...
def compile_abc(filename, abcname=None):
    ...
    elif abcname.endswith('.abc'):
        abcname, _ = os.path.splitext(abcname)
    module = new.module(abcname)
    namespace = module.__dict__.get('_namespace_', abcname)
